/*
	g++ getCalibrated_v2.cpp -o getCalibrated_v2 `pkg-config opencv --cflags --libs`
	./getCalibrated_v2 
...
int main(){
				...
				//It will have as many iterations as there are images.
	{
			...
			found = findChessboardCornersSB(imgGray,patternsize,corners2D,
				...
				//This function is analog to 'findChessBoardCorners' use in version1. 
				//Nevertheless this is way better and will provide a more precise calibration
				//of the camera. But, the problem it is needed OpneCV version 4.0.0 or higher
				
				//The function does the same as the combination of functions 
				//findChessboardCorner + cornerSubPix, it finds the positions of internal
				//corners of the chessboard using a sector based approach. 
